/*
  ...
  - You are about to drop the column `orderHeadcount` on the `assignments` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "assignment_days" ADD COLUMN "orderHeadcount" INTEGER;
...
INSERT INTO "new_assignments" ("assignmentType", "belongings", "contactName", "contactTel", "createdAt", "dailyRateOverride", "endDate", "endTime", "id", "jobSiteId", "notes", "shiftType", "staffId", "startDate", "startTime", "transportation", "updatedAt", "vehicleId") SELECT "assignmentType", "belongings", "contactName", "contactTel", "createdAt", "dailyRateOverride", "endDate", "endTime", "id", "jobSiteId", "notes", "shiftType", "staffId", "startDate", "startTime", "transportation", "updatedAt", "vehicleId" FROM "assignments";
